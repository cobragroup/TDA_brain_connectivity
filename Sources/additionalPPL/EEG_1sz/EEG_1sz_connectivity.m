...
fpathIn = 'Service/ScalpEEG/Data/';

load([fpathIn 'eeg_1sz_30sec.mat']);
...
matrix = [sz pre];
save(['Service/PaperUpd/EEG_1sz/Matrices/EEG_1sz_fullFC' mark '.mat'],'pre','sz','matrix')
...
matrix = [sz pre];
save(['Service/PaperUpd/EEG_1sz/Matrices/EEG_1sz_maskedFC' mark '.mat'],'pre','sz','matrix')
...
% end
% matrix = [sz pre];
% save(['Service/PaperUpd/EEG_1sz/Matrices/EEG_1sz_fullEC' mark '.mat'],'pre','sz','matrix')
% 
% disp('******************* Masked EC');
% for iP = 1:nSbj
%     
...
% end
% matrix = [sz pre];
% save(['Service/PaperUpd/EEG_1sz/Matrices/EEG_1sz_maskedEC' mark '.mat'],'pre','sz','matrix')
% 
% 
